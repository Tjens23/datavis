                ...
                with ui.card(full_screen=True, style="min-height: 500px"):
                    with ui.card_header(class_="d-flex justify-content-between align-items-center"):
                        ...
                        with ui.popover(title="Chart settings", placement="top"):
                            ICONS["ellipsis"]
                            ui.input_radio_buttons("time_aggregation", "Aggregation",
                                ["Daily", "Weekly", "Monthly"], selected="Weekly", inline=True)
                    ...
                    def time_series_chart():
                        ...
                        return ui_module.HTML(f'<img src="data:image/gif;base64,{gif}" style="max-width:100%; height:auto;" />')

                # Outliers infographic
